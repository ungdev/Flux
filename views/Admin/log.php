...
<div>
	...
	<select id="select_type_stock" name="id_type_stock"><?php echo $vars['admin']->retourneSelectTypeStock($Value['id_cat_prob']??'') ?></select>
	<select id="select_type_espace" name="id_espace"><?php echo $vars['admin']->retourneSelectSimulBar($Value['id_espace']??'') ?></select>
